...
LANG[PROMPT_ACTION]="Выберите действие (0-6):"
LANG[INVALID_CHOICE]="Неверный выбор. Выберите 0-6."
...
LANG[ENV_EXISTS]="Панель уже установлена — сохраняю существующий .env (секреты и БД не трогаю), обновляю домены."
...
LANG[PANEL_ACCESS_INVALID]="Неверный выбор. Выберите 0-2."
...
LANG[NODE_PANEL_LOGIN_PROMPT]="Введите логин суперадмина панели: "
LANG[NODE_PANEL_PASSWORD_PROMPT]="Введите пароль суперадмина панели: "
LANG[NODE_API_STEPS]="Регистрируем ноду в панели через API (Remnawave 3.x)..."
LANG[NODE_AUTH_LOGIN_SUCCESS]="Вход в панель выполнен, токен получен."
LANG[NODE_API_AUTH_FAIL]="Не удалось авторизоваться в панели (логин/пароль). Проверьте данные."
LANG[NODE_API_TOKEN_INVALID]="API-токен недействителен или у него нет доступа к API панели."
LANG[NODE_PANEL_IP_REACH_FAIL]="Не удалось подключиться к API панели по адресу %s. Проверьте IP панели и доступность порта 3000."
LANG[NODE_ADDRESS_PROMPT]="Введите IP-адрес ноды, по которому панель будет подключаться (адрес:2222): "
LANG[NODE_ADDRESS_INFO]="IP-адрес ноды для панели: %s"
