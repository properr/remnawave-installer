...
SCRIPT_VERSION="26.8.7.13"
UPDATE_AVAILABLE=false
DIR_REMNAWAVE="/usr/local/remnawave_reverse/"
LANG_FILE="${DIR_REMNAWAVE}selected_language"
SCRIPT_URL="https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/install_remnawave.sh"
LANG_BASE_URL="https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/src/lang"
...
download_with_mirrors() {
    ...
    local mirrors=(
        ...
        "https://raw.githack.com/properr/remnawave-installer/main/${file_url#*main/}"
...
show_menu() {
    ...
    echo -e ""
    echo -e "${COLOR_YELLOW}4. ${LANG[MENU_9]}${COLOR_RESET}" # Manage certificates domain
    echo -e ""
    echo -e "${COLOR_YELLOW}5. ${LANG[MENU_10]}${COLOR_RESET}" # Check for updates
    echo -e "${COLOR_YELLOW}6. ${LANG[MENU_11]}${COLOR_RESET}" # Remove script
    echo -e ""
    echo -e "${COLOR_YELLOW}0. ${LANG[EXIT]}${COLOR_RESET}"
...
load_module() {
    ...
    local module_url="https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/src/${module_type}/${module_name}.sh"
