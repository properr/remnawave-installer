...
2. Создайте учётную запись
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/docs/src/assets/ru/netbird/register.png" 
...
5. После этого вы попадёте в панель Netbird.
    ...
    ![Netbird peer](https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/docs/src/assets/ru/netbird/peer.png)
...
1. Переходим в раздел Setup Keys. Нажмите кнопку Create Setup Key.
    ...
    ![Netbird setup key](https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/docs/src/assets/ru/netbird/setup_key.png)

2. Создайте установочный ключ.

    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/docs/src/assets/ru/netbird/create_new_setup_key.png" 
...
Скопируйте ключ и сохраните его в безопасном месте для дальнейшего использования.
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/docs/src/assets/ru/netbird/key.png" 
        alt="Netbird key" 
        style={{ maxWidth: '60%' }} 
      />
    </div>
...
1. Нажмите кнопку `Install Netbird`.
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/docs/src/assets/ru/netbird/install_netbird.png" 
        alt="Netbird create setup key" 
        style={{ maxWidth: '75%' }} 
      />
    </div>
...
2. Установите Netbird на сервере панели Remnawave. Выполните команду для установки Netbird:
    ...
    ![Netbird setup](https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/docs/src/assets/ru/netbird/setup_netbird.png)
...
3. Запустите Netbird с ключом, который вы скопировали ранее. Выполните команду для подключения с использованием сохранённого ключа (у вас будет свой ключ):
    ...
    ![Netbird setup](https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/docs/src/assets/ru/netbird/setup_netbird2.png)
...
![Netbird peer](https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/docs/src/assets/ru/netbird/peer_netbird.png)

## Установка Netbird на сервер с нодой Remnawave

Проделайте те же действия установки, что и на [`сервере панели`](https://github.com/properr/remnawave-installer/ru/configuration/netbird/#%D1%83%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%BA%D0%B0-netbird-%D0%BD%D0%B0-%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%D0%BF%D0%B0%D0%BD%D0%B5%D0%BB%D0%B8-remnawave).
...
![Netbird peer](https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/docs/src/assets/ru/netbird/peer_netbird_node.png)
...
3. В поле `Адрес` введите IP-адрес Netbird ноды (в нашем случае это 100.88.74.220, у вас может быть другой).
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/docs/src/assets/ru/netbird/ip_netbird_node.png" 
        alt="Netbird create setup key" 
        style={{ maxWidth: '75%' }} 
      />
    </div>
...
![Netbird peer](https://raw.githubusercontent.com/properr/remnawave-installer/refs/heads/main/docs/src/assets/ru/netbird/ip_netbird_node1.png)
